package tema7_parte3.wallapop.io;


import tema7_parte3.wallapop.models.*;
import tema7_parte3.wallapop.services.GestionComprasVentas;
import tema7_parte3.wallapop.services.VentasUsuario;
        ...
        try {
            Files.lines(Paths.get("resources/compras.csv"))
                    .forEach(linea -> {
                        ...
                        //Añade la compra que hay en el fichero a GestionComprasVentas
