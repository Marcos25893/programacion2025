...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Employee e1 = new Employee(1, "EMP1", "e1@emp.es", Department.DESARROLLO);
        Employee e2 = new Employee(2, "EMP2", "e2@emp.es", Department.DIRECCION);
        ...
        Project pr1 = new Project("Página wb de ventas de la empresa");
